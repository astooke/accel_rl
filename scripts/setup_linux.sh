...
hash conda 2>/dev/null || {
    echo "Please install anaconda before continuing. You can download it at https://www.continuum.io/downloads."
    exit 0
}
...
echo "Conda environment created! Make sure to run \`source activate arl\` whenever you open a new terminal and want to run programs under accel_rl."
