...
script = "accel_rl/scripts/example/example_train_a3c.py"

# n_gpu, ctx_per_gpu, ctx_per_run, n_cpu_cores, n_sockets, (ht_offset)
affinity_code = "4gpu_1cxg_4cxr_20cpu"  # (write according to computer specs)
...
sub_names = ["a2c_{}lr_{}envs".format(*exp) for exp in exps]
