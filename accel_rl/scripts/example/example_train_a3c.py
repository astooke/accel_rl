...
from accel_rl.algos.pg.a2c import mA3C
...
def build_and_run(run_slot_affinities_code, log_dir, game, game_run_ID,
    ...
    assert n_envs % (n_sim_cores * 2) == 0  # one core alternates between simulating two groups of envs sequentially
