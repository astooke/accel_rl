...
script = "accel_rl/scripts/example/example_train_a2c.py"

# n_gpu, ctx_per_gpu, ctx_per_run, n_cpu_cores, n_sockets, (ht_offset)
affinity_code = "1gpu_2cxg_1cxr_10cpu"  # (write according to computer specs)
...
exps = list(zip(learning_rates, policy))

sub_names = ["a2c_{}lr_{}policy".format(*exp) for exp in exps]
